...
def main():
    ap = argparse.ArgumentParser("AFHQ Oracle (TarFlow)")
    ...
    ap.add_argument("--classes", nargs="+", default=["cat","dog","wild"])
    ap.add_argument("--prior_json", type=str, default="data/afhq_class_prior.json")
